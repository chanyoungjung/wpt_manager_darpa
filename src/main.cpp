...
// void genRandomWPT(double range_x_local_min, double range_x_local_max, double
// range_y_local_min,
...
//       range_x_local_min + (rand() % static_cast<int>(range_x_local_max -
//       range_x_local_min + 1));
//   // double random_wpt_y_ = range_y_local_min + ff * (range_y_local_max -
//   range_y_local_min); seed = time(0); srand(seed); double random_wpt_y_ =
//       range_y_local_min + (rand() % static_cast<int>(range_y_local_max -
//       range_y_local_min + 1));
...
//   nh.getParam("random_generation_coordination",
//   random_generation_coordination);
...
//   nh.getParam("random_generation_global_x_min",
//   random_generation_global_x_min);
//   nh.getParam("random_generation_global_x_min",
//   random_generation_global_x_max);
//   nh.getParam("random_generation_global_y_min",
//   random_generation_global_y_min);
//   nh.getParam("random_generation_global_y_min",
//   random_generation_global_y_max);
//   nh.getParam("random_generation_global_z_min",
...
//           genRandomWPT(RANDOM_MIN_X, RANDOM_MAX_X, RANDOM_MIN_Y,
//           RANDOM_MAX_Y);
...
int main(int argc, char **argv) {
  ...
  while (ros::ok()) {
    ...
    if (current_wpt_idx == 0) {
      ...
      path_msg.poses.push_back(pt_msg);
      local_goal_publisher.publish(path_msg);
